...
@testset "1380.lucky-numbers-in-a-matrix.jl" begin
    @test lucky_numbers([[3,7,8],[9,11,13],[15,16,17]]) == [15]
    @test lucky_numbers([[1,10,4,2],[9,3,8,7],[15,16,17,12]]) == [12] 
    @test lucky_numbers([[7,8],[1,2]]) == [7]
end
## @lc test=end


## @lc info=start
# link: [solution to 1380](https://leetcode-cn.com/problems/lucky-numbers-in-a-matrix/solution/1380-ju-zhen-zhong-de-xing-yun-shu-julia-ehjx/)
## @lc info=end