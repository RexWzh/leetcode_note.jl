...
function merge_trees(root1::Union{TreeNode, Nothing}, root2::Union{TreeNode, Nothing})::Union{TreeNode, Nothing}
    isnothing(root1) && return root2
    isnothing(root2) && return root1
    root = TreeNode{Int}([root1.val + root2.val])
